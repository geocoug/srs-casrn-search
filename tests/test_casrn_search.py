...
def test_send_bad_request() -> None:
    """Test that the send_request() method raises the
    appropriate error with a bad request.
    """
    url = (
...
def test_send_good_request() -> None:
...
def test_casrn_search_no_synonyms() -> None:
    """Test that the output gnerated by casrn_search()
